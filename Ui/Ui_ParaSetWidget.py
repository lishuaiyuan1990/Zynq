...
#
# Created: Wed Oct 25 23:07:32 2017
...
class Ui_ParaSetWidget(object):
    def setupUi(self, ParaSetWidget):
        ...
        ParaSetWidget.resize(201, 403)
        self.layoutWidget = QtGui.QWidget(ParaSetWidget)
        self.layoutWidget.setGeometry(QtCore.QRect(0, 0, 201, 381))
        ...
        self.horizontalLayout_13.addWidget(self.m_openSysBtn)
        ...
        self.horizontalLayout_13.addWidget(self.m_stopSysBtn)
    ...
    def retranslateUi(self, ParaSetWidget):
        ...
        self.m_chanChecked.setText(_translate("ParaSetWidget", "使能", None))
